...
const __null_assert = `function __na(v){if(n(v))throw TypeError("Null assertion");return v}`;
...
export function wrap(code: string, used: Readonly<Record<string, boolean>>) {
